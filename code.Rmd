...
# Create the plot
plot_title <- "Posterior Default Mode Network (IC20)"
...
# Create the plot
plot_title <- "Multimodal Visual Association Network (IC4)"
...
# Create the plot
plot_title <- "Primary Visual Cortex Network (IC8)"
...
# Create the plot
plot_title <- "Posterior Visual Processing Unit (IC19)"
...
# Create the plot
plot_title <- "Integrative Visual Processing Network (IC2)"
